 ...
 */
/*
Plugin Name: Cart2Cart: Squirrelcart to WooCommerce Migration Module
...
function cart2cart_config(){
	...
	$sourceCartName = 'Squirrelcart';
  $sourceCartId = 'Squirrelcart242';
  $sourceCartUrl = 'squirrelcart';
	$referertext = 'Cart2Cart: '. $sourceCartName  . ' to '. $cartName  . ' module';
	$sourceCartLogo = 'https://www.shopping-cart-migration.com/images/stories/'.strtolower($sourceCartName).'.gif';
